...
class Test(unittest.TestCase):
    ...
    def test_function1_1(self):
        try:
            self.create_a_txt()
            self.test = car_registration.add_car("Test_cars.txt","Yuko", "modeltest", "2011", "YUKO2011")

            # refresh the file
            self.create_a_txt()
            self.assertEqual(car_registration.add_car("Test_cars.txt","Yuko", "modeltest", "2011", "YUKO2011")[0],True)
    ...
    def test_function1_2(self):
        try:
            ...
            with self.assertRaises(ValueError):
                car_registration.add_car("Test_cars.txt","INVALID!", "modeltest", "2011", "YUKO2011")
    ...
    def test_function1_3(self):
        try:
            ...
            with self.assertRaises(ValueError):
                car_registration.add_car("Test_cars.txt","YUKO", "INVALID!", "2011", "YUKO2011")
    ...
    def test_function1_4(self):
        try:
            ...
            with self.assertRaises(ValueError):
                car_registration.add_car("Test_cars.txt","YUKO", "modeltest", "INVALID!", "YUKO2011")
    ...
    def test_function1_5(self):
        try:
            ...
            with self.assertRaises(ValueError):
                car_registration.add_car("Test_cars.txt","YUKO", "modeltest", "2011", "invalid1-5")
    ...
    def test_function1_6(self):
        try:
            ...
            # self.create_a_txt()
            with self.assertRaises(ValueError):
                car_registration.add_car("Test_cars.txt","Yuko", "modeltest", "2011", "YUKO2011")
            os.remove("Test_cars.txt")
    ...
    def test_function2_1(self):
        try:
            ...
            self.assertListEqual(car_registration.display_cars("Test_cars.txt")[1],[39,47])
            os.remove("Test_cars.txt")
    ...
    def test_function3_1(self):
        try:
            self.create_a_txt()
            self.test = car_registration.find_a_car("Test_cars.txt","ABC777",unit_test=True)
            self.assertEqual(car_registration.find_a_car("Test_cars.txt","ABC777",unit_test=True)[0], True)
            os.remove("Test_cars.txt")
    ...
    def test_function3_2(self):
        try:
            self.create_a_txt()
            self.test = car_registration.find_a_car("Test_cars.txt","ZZZ999",unit_test=True)

            self.assertEqual(car_registration.find_a_car("Test_cars.txt","ZZZ999",unit_test=True)[0], False)
    ...
    def test_function3_3(self):
        try:
            self.create_a_txt()
            with self.assertRaises(ValueError):
                car_registration.find_a_car("Test_cars.txt","INVALID!!",unit_test=True)
            os.remove("Test_cars.txt")
    ...
    def test_function4_1(self):
        try:
            self.create_a_txt()
            self.test = car_registration.remove_a_car("Test_cars.txt","ABC777",unit_test=True)

            self.create_a_txt()
            self.assertEqual(car_registration.remove_a_car("Test_cars.txt","ABC777",unit_test=True), True)
            os.remove("Test_cars.txt")
    ...
    def test_function4_2(self):
        try:
            self.create_a_txt()
            self.test = car_registration.remove_a_car("Test_cars.txt","ZZZ999",unit_test=True)

            self.assertEqual(car_registration.remove_a_car("Test_cars.txt","ZZZ999",unit_test=True), False)
            os.remove("Test_cars.txt")
    ...
    def test_function4_3(self):
        try:
            self.create_a_txt()
            with self.assertRaises(ValueError):
                car_registration.remove_a_car("Test_cars.txt","INVALID!!!",unit_test=True)
            os.remove("Test_cars.txt")
